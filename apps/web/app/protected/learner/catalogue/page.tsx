  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      <section className="space-y-3">
        <Link className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-widest text-muted-foreground uppercase transition-colors hover:text-foreground" href="/protected/learner">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-muted-foreground">Explore the learning areas available to you, then choose a theme to continue or start practising.</p>
        </div>
      </section>
